...
<!----------Dashboard----------->
  ...
  <section class="main">
      <div>
        ...
        <div class="text-box">
            <a href="Edit_Tpo_Account.php" role="button" class="hero-btn">Edit Account</a>
            <a href="Add_Company.php" role="button" class="hero-btn">Add Company</a>
            <a href="Track_student.php" role="button" class="hero-btn">Track Student</a>
            <a href="notify_drive.php" role="button" class="hero-btn">Notify Drive</a>
        </div>
